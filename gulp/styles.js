...
/**
 * Compiles the SCSS of the bmg-ui kit into a single CSS file at '.tmp/css/bmg-ui.css'.
 */
gulp.task('styles:dev:kit', function () {
  return gulp.src('source/kit/stylesheets/bmg-ui.scss')
      .pipe(scsslint())
...
/**
 * Compiles the SCSS of the bmg-ui kit and the docs for distribution.
 */
...
/**
 * Compiles the SCSS of the bmg-ui kit to 'dist/stylesheets/css/...'. Also puts the same file
